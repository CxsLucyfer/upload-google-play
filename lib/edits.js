...
function uploadRelease(options, releaseFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (releaseFile.endsWith('.apk')) {
            ...
            yield internalTrackVersionCode(appEdit.data, options, apk.versionCode);
        }
            ...
            yield internalTrackVersionCode(appEdit.data, options, bundle.versionCode);
        }
        else {
...
function internalTrackVersionCode(appEdit, options, versionCode) {
    return __awaiter(this, void 0, void 0, function* () {
        core.debug(`Creating Internal Track Release for Edit(${appEdit.id}) for Track(internal) with a UserFraction(completed) and VersionCode(${versionCode})`);
        const res = yield androidPublisher.edits.tracks
            .update({
            auth: options.auth,
            editId: appEdit.id,
